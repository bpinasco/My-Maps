...
const val EXTRA_USER_MAP = "EXTRA_USER_MAP" //this will serve as a key that can be accessed in multiple activities
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapAdapter = MapsAdapter(this, userMaps,object: MapsAdapter.OnClickListener{
            //Pass in implementation of the interface OnClickListener
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if(requestCode == REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            serializableUserMaps(this,userMaps)
        }
        super.onActivityResult(requestCode, resultCode, data)
    }

    private fun serializableUserMaps(context:Context, userMaps: List<UserMap>){
    ...
    //private fun deleteUserMaps(context:Context, userMaps: List<UserMap>){
    //    Log.i(TAG,"deleteUserMaps")
    //}
